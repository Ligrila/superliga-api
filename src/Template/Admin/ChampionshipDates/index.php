  ...
  <div class="card-block">
    ...
    <div class="dates index no-more-tables">
        <table class="table table-striped">
            ...
            <tbody>
                <?php foreach ($championshipDates as $date): ?>
                <tr>
                        ...
                        <?php // $this->Html->link(__('Ganadores'), ['action' => 'winners', $date->id],['class'=>'btn btn-sm btn-primary']) ?>
                        ...
                        <?php // $this->Html->link(__('Preguntas'), ['action' => 'view', $date->id],['class'=>'btn btn-sm btn-info']) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
