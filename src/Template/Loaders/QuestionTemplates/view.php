<nav class="nav nav-pills">
    ...
    <?= $this->Html->link(
            ...
            ['action' => 'edit', $questionTemplate->id],
...
<div class="questionTemplates view flex-xs scroll-y p-a-3">
  <div class="column-equal m-b-2">
                    <div class="col">
                      <div class="circle-icon circle-icon-large bg-info">Q</div>
                    </div>
                    <div class="col v-align-middle p-l-2">
                      <h1>
                        <?= h($questionTemplate->id) ?>
                      </h1>
                    </div>
    </div>
