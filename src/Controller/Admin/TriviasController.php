 ...
 */
class TriviasController extends AdminAppController
{
    ...
    public function finishHalfTime($id){
         // $this->request->setAllowMethod(['post','put']);
    ...
    public function showBanner($id){
        $this->request->allowMethod(['post','put']);
        $saved = $this->Trivias->showBanner($id);
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            //debug($trivia);
            //die;
            //debug($this->request->getSession()->read('user_timezone'));
            //$trivia->start_datetime = $trivia->start_datetime->timezone($this->request->getSession()->read('user_timezone'));

            //$data['date_id'] = $this->Trivias->assignDate($trivia);
            //$trivia = $this->Trivias->patchEntity($trivia, $data);

            if ($saved = $this->Trivias->save($trivia)) {
                $this->Flash->success(__('La trivia fue guardada correctamente'));
                //debug($saved);die;
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            $trivia->setDirty('start_datetime',true);
