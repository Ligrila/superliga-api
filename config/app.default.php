<?php
// Mercadopago
//Public key: TEST-92203fe0-971e-4c9c-aacf-336605350021
//Access token: TEST-1000029667927562-082108-d20ef3a1544c87025835738e174da67f-37047808
return [
    /**
     * Debug Level:
     *
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'a95178965a1f5d9e9bb29ba29ca798da950f4bd13944343a2aac3919feb9453f'),
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'password' => env('DATABASE_PASSWORD','superliga'),
            'database' => env('DATABASE_NAME','superliga'),
            /*
    ...
    'recaptcha'=>[
        ...
        'secretkey' => '6LfCzGcUAAAAAHTCBBffuboisOo3_vT6hTc6m6FI',
    ],
    'mercadopago'=>[
        'clientID'=>'5989787232639726',
        'clientSecret'=>'MW3OFjBnOvSqjflqjLsHXmZ0uLZP5U17',
        'notificationUrl' => 'https://superliga.mocla.us/api/payments/notification',
        // alex
        // 563097293152404
        // udlImCEF9oiLrWzSBw6DcBsRyY6BcSb1
    ],
    'Microservices'=>[
        'Answers' => [
            'add' => 'http://localhost/microservices/answers/add.php'
        ]
    ],
    'Redis' => [
        'host' => 'redis',
