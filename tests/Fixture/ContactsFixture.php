...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contact_topic_id' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'user_id' => '55d4448c-ca15-4d75-be3d-0a075ba132c4',
                'contact_topic_id' => 1,
