 ...
 *
 */
class LivePacksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'currency_id' => ['type' => 'string', 'fixed' => true, 'length' => 3, 'null' => false, 'default' => 'ARS', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'price' => 1.5,
                'currency_id' => 'L',
                'created' => '2018-08-21 13:34:00',
                'modified' => '2018-08-21 13:34:00'
            ],
        ];
        parent::init();
    }
