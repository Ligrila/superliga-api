...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'picture' => ['type' => 'proffer.file', 'length' => 255, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'picture_dir' => ['type' => 'integer', 'length' => 255, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => '41a26d02-a759-4699-b305-c007b1cf816a',
                ...
                'picture' => '',
                'picture_dir' => 1,
                'created' => '2018-07-31 10:35:29',
                'modified' => '2018-07-31 10:35:29'
            ],
        ];
        parent::init();
    }
